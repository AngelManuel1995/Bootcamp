...
class GameTeamsControllerTest < ActionController::TestCase
  ...
  test "should create game_team" do
    assert_difference('GameTeam.count') do
      post :create, game_team: { game_id: @game_team.game_id, result: @game_team.result, team_id: @game_team.team_id }
    end
  ...
  test "should update game_team" do
    patch :update, id: @game_team, game_team: { game_id: @game_team.game_id, result: @game_team.result, team_id: @game_team.team_id }
    assert_redirected_to game_team_path(assigns(:game_team))
  end
